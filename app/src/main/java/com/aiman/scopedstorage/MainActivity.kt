...
import com.aiman.scopedstorage.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun loadPhotosFromInternalStorageIntoRecyclerView() {
        lifecycleScope.launch {
            ...
            Log.d("sizeeee", "${photos[0].bmp.byteCount/1024}")
    ...
    private fun checkPermissions() {
        ...
        // we don't need write permission if SDK is 29 or greater
    ...
    private fun savePhotoToExternalStorage(displayName: String, bmp: Bitmap): Boolean {
        ...
        val imageCollection = sdk29AndUp {
            // In Android 29 and above we can only access Volume External Primary
            MediaStore.Images.Media.getContentUri(MediaStore.VOLUME_EXTERNAL_PRIMARY)
        } ?: MediaStore.Images.Media.EXTERNAL_CONTENT_URI

        // Storing some meta-data with the image
